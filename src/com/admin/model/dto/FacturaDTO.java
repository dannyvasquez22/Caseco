...
public class FacturaDTO {
    ...
    public FacturaDTO(int codigo, int serie, int numero, Date fecha, Time hora, double total, int estCancelacion, int estEntrega, int estado, Date fechaEntrega, ClienteDTO cliente, DetalleCargoDTO detalleCargoVendedor, DetalleCargoDTO detalleCargoCajero, DetalleTiendaDTO detalleTienda) {
        this.codigo = codigo;
        this.serie = serie;
        this.numero = numero;
        this.fecha = fecha;
    ...
    public FacturaDTO(int codigo, int serie, int numero, Date fecha, Time hora, double total, int estCancelacion, int estEntrega, Date fechaEntrega, ClienteDTO cliente, DetalleCargoDTO detalleCargoCajero, DetalleTiendaDTO detalleTienda) {
        this.codigo = codigo;
        this.serie = serie;
        this.numero = numero;
        this.fecha = fecha;
