...
public class Clientes_CRUDPadreDialog extends javax.swing.JDialog {
    ...
    final static Logger logger = Logger.getLogger(Clientes_CRUDPadreDialog.class);

    @SuppressWarnings("OverridableMethodCallInConstructor")
    public Clientes_CRUDPadreDialog(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(panelFactura, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE)))
        ...
        if (panelFactura.isVisible()) {
            if (txtRuc.getText().equals("") || txtRazonSocial.getText().equals("")) {
               Messages.messageAlert();
                ...
                try {
                    esRepetido = esClienteFacturaRepetido(txtRuc.getText(), txtRazonSocial.getText(), Integer.parseInt(codigoCliente));
                    if (esRepetido) {
                        ...
                        result = ClienteBL.getInstance().update(cliente);
                        if (!result) Messages.messageError("Error al modificar cliente factura.");
                    }
                } catch (SQLException ex) {
                    logger.error(ex);
                }
            ...
            if (txtDni.getText().equals("") || txtNombre.getText().equals("")) {
                ...
                try {
                    esRepetido = esClienteBoletaRepetido(txtDni.getText(), txtNombre.getText(), Integer.parseInt(codigoCliente));
                    if (esRepetido) {
                        Messages.messageRepeat();
                    } else {
                        cliente = new ClienteDTO(
                        ...
                        result = ClienteBL.getInstance().update(cliente);
                        if (!result) Messages.messageError("Error al modificar cliente boleta.");
                    }
                } catch (SQLException ex) {
                    Messages.messageError("Error: " + ex.toString());
                    logger.error(ex);
        ...
        if (!boxDepartamento.getSelectedItem().toString().equals("")) {
            try {
                ...
                if (direccion == null) {
                    ...
                    if (!result)    Messages.messageAlert("Error en datos direccion.");
                }
            } catch (SQLException ex) {
    ...
    private void btnAgregarIntermediarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarIntermediarioActionPerformed
        ...
        if (txtNombreIntermediario.getText().equals("")) {
            ...
            if (crudModificar == 0) {
                ...
                for (int cont = 0; cont < tblIntermediario.getRowCount(); cont++) {
                    if (!registroEmpleado[0].equals("-")) {
                        if (registroEmpleado[0].equals(tblIntermediario.getValueAt(cont, 1).toString()) &&
                                registroEmpleado[1].equals(tblIntermediario.getValueAt(cont, 2).toString())) {
                            esRepetido = true;
                        }
                    } else {
                        if (registroEmpleado[1].equals(tblIntermediario.getValueAt(cont, 2).toString())) {
                            esRepetido = true;
                        }
                    }
                }
    ...
    private void btnModificarMovilIntermediarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarMovilIntermediarioActionPerformed
        ...
        if (boxReferencia.getSelectedItem() == null || txtNumeroIntermediario.getText().equals("")) {
            ...
            if (crudModificar == 0) {
                ...
                if (!tblMovilIntermediario.getValueAt(filaTelefonoEmpleado, 4).toString().equals(registroTelefonoEmpleado[3])) {
                    for (int cont = 0; cont < tblMovilIntermediario.getRowCount(); cont++) {
                        if (registroTelefonoEmpleado[3].equals(tblMovilIntermediario.getValueAt(cont, 4).toString())) {
                            esRepetido = true;
                        }
                    }
                }
            ...
            if (esRepetido == true) {
                ...
                if (crudModificar == 0) {
                    ...
                    try {
                        if (!registroTelefonoEmpleado[0].equals(tblMovilIntermediario.getValueAt(filaTelefonoEmpleado, 1).toString())) {
                            for (int cont = 0; cont < tblIntermediario.getRowCount(); cont++) {
    ...
    private void tblMovilIntermediarioMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblMovilIntermediarioMouseClicked
        ...
        if (crudModificar == 0) {
            ...
            boxReferencia.setSelectedItem(tblMovilIntermediario.getValueAt(filaTelefonoEmpleado, 1).toString());
            if (tblMovilIntermediario.getValueAt(filaTelefonoEmpleado, 2) == null) {
                boxTelefoniaIntermediario.setSelectedItem(null);
            } else {
                boxTelefoniaIntermediario.setSelectedItem(tblMovilIntermediario.getValueAt(filaTelefonoEmpleado, 2).toString());
            }
            if (tblMovilIntermediario.getValueAt(filaTelefonoEmpleado, 3) == null) {
                boxTipoTelefoniaIntermediario.setSelectedItem(null);
            } else {
                boxTipoTelefoniaIntermediario.setSelectedItem(tblMovilIntermediario.getValueAt(filaTelefonoEmpleado, 3).toString());
            }
            txtNumeroIntermediario.setText(tblMovilIntermediario.getValueAt(filaTelefonoEmpleado, 4).toString());
        }
    ...
    private void btnAgregarObservacionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarObservacionActionPerformed
        ...
        if (textDescripcion.getText().equals("") || txtFechaObservacion.getText().equals("")) {
            ...
            if (crudModificar == 0) {
                Messages.messageInsert();                
                String[] fila = {txtFechaObservacion.getText(), textDescripcion.getText()};
                modeloObservacion.addRow(fila);
                tblObservacion.setModel(modeloObservacion);  
                ActivaObservacion();              
            } else {
                try {
    ...
    private void btnModificarObservacionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarObservacionActionPerformed
        ...
        if (textDescripcion.getText().equals("") || txtFechaObservacion.getText().equals("")) {
            ...
            if (crudModificar == 0) {
                Messages.messageUpdate();                
                String[] datos = {txtFechaObservacion.getText(), textDescripcion.getText()};
                for (int i = 0; i < tblObservacion.getColumnCount(); i++) {
                    modeloObservacion.setValueAt(datos[i], filaObservacion, i);
                } 
                ActivaObservacion();              
            } else {
                try {
    ...
    private void boxTipoClienteItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_boxTipoClienteItemStateChanged
        ...
        if (boxTipoCliente.getSelectedItem().toString().equals("")) {
            Pestañas.setEnabled(false);
            panelBoleta.setVisible(false);
            panelBoleta.setEnabled(false);
            panelFactura.setVisible(false);
            panelFactura.setEnabled(false);
        }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            Clientes_CRUDPadreDialog dialog = new Clientes_CRUDPadreDialog(new javax.swing.JDialog(), true);
