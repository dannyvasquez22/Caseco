...
public class Empleados_CRUDPadreDialog extends javax.swing.JDialog {
    ...
    final static Logger logger = Logger.getLogger(Empleados_CRUDPadreDialog.class);
    
    public Empleados_CRUDPadreDialog(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(lblEstado, javax.swing.GroupLayout.PREFERRED_SIZE, 123, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(412, 412, 412)
            ...
            try {
                ...
                if (esRepetido == false) {
                    ...
                    try {
                        ...
                        Messages.messageError("Error: " + ex.getMessage());
                    }
                    ...
                    if (!result)    Messages.messageAlert("Error en datos de empleado.");
                    ...
                    if (!result)    Messages.messageAlert("Error en datos del detalle de cargo.");
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        ...
        if (txtCodigo.getText().equals("") || txtNombre.getText().equals("") || (!rbtnMasculino.isSelected() && !rbtnFemenino.isSelected())
            ...
            if (!txtEmail.getText().equals("")) {           textmail = txtEmail.getText();      }
            if (!txtSueldo.getText().equals("")) {          textsueldo = txtSueldo.getText();   }
            if (!lblEstado.getText().equals("Activo")) {    estado = 0;                         }
            ...
            try {
                ...
                result = EmpleadoBL.getInstance().update(empleado, codigoEmpleado);
                if (!result)    Messages.messageAlert("Error en datos de empleado.");
                ...
                detalleCargo = new DetalleCargoDTO(
                        ...
                        fechaFin,
                        Float.parseFloat(textsueldo),
                        new EmpleadoDTO(codigoEmpleado),
                        new CargoDTO(boxCargos.getSelectedItem().toString())
                );
                
                result = DetalleCargoBL.getInstance().update(detalleCargo);
                if (!result)    Messages.messageAlert("Error en datos del detalle cargo.");
                
                if (!boxDepartamento.getSelectedItem().toString().equals("")) {
                    direccion = DireccionBL.getInstance().getByTipo("EMPLEADO", txtCodigo.getText());
                    if (direccion == null) {
                        direccion = new DireccionDTO(
                                boxDepartamento.getSelectedItem().toString(),
                                txtProvincia.getText(),
        ...
        if (txtNumero.getText().equals("")) {
            ...
            if (esRepetido == true) {
                ...
                if (crudModificar == 0) {
                    ...
                    try {
                        telefono = new TelefonoDTO(
                                boxTelefono.getSelectedItem().toString(),
    ...
    private void tblTelefonoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblTelefonoMouseClicked
        ...
        if (crudModificar == 0) {
            ...
            if (tblTelefono.getValueAt(filaTelefono, 1) != null) {
                boxTelefono.setSelectedItem(tblTelefono.getValueAt(filaTelefono, 1).toString());
            }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Empleados_CRUDPadreDialog dialog = new Empleados_CRUDPadreDialog(new javax.swing.JDialog(), true);
