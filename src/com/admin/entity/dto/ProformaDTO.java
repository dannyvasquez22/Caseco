...
public class ProformaDTO {
    ...
    public ProformaDTO(int codigo, int serie, int numero, Date fecha, Time hora, double total, int estado, ClienteDTO cliente, DetalleCargoDTO detalleCargoVendedor, DetalleCargoDTO detalleCargoCajero, DetalleTiendaDTO detalleTienda) {
        this.codigo = codigo;
        this.serie = serie;
        this.numero = numero;
        this.fecha = fecha;
    ...
    public ProformaDTO(int codigo, Date fecha, Time hora, double total, ClienteDTO cliente, DetalleCargoDTO detalleCargoCajero, DetalleTiendaDTO detalleTienda) {
        this.codigo = codigo;
        this.fecha = fecha;
        this.hora = hora;
        this.total = total;
