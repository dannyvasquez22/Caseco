...
public class TProductoAlmacen  extends AbstractTableModel {
    ...
    private final String []titulos = {"CÓDIGO", "RAZÓN SOCIAL", "LUGAR", "STOCK", "STOCK CRITICO"};
    
    public TProductoAlmacen(ArrayList<ProductoAlmacenP> arrayList) {
       productos = arrayList;
    }
