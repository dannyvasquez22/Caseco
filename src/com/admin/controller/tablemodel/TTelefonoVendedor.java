...
public class TTelefonoVendedor  extends AbstractTableModel {
    private ArrayList<TelefonoVendedorP> telefonos = null;
    ...
    public TTelefonoVendedor(ArrayList<TelefonoVendedorP> arrayList) {
       telefonos = arrayList;
    }
